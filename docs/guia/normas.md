...
* **Perceptíveis:** A informação e a interface devem ser claras e apresentadas de forma que os utilizadores possam percebê-las por diferentes sentidos.
...
* **Robustos:** O código e a marcação semântica devem ser compatíveis com uma ampla gama de agentes de utilizador, incluindo tecnologias assistivas atuais e futuras.
